<div class="dashboard-left-sidebar">
    ...
    <div class="profile-card">
        <div class="profile-header">
            <div class="profile-bg" 
                 style="background-image: url('<?php echo e(auth()->user()->cover_image ? asset('storage/' . auth()->user()->cover_image) : ''); ?>')">
        ...
        <div class="profile-info">
            <h4 class="profile-name"><?php echo e(auth()->user()->name); ?></h4>
    ...
    <div class="sidebar-menu">
        <div class="menu-section">
            ...
            <ul class="menu-list">
                <li class="menu-item">
                    <a href="<?php echo e(route('account.index')); ?>" class="menu-link <?php echo e(request()->routeIs('account.index') ? 'active' : ''); ?>">
                        <div class="menu-icon">
                ...
                <li class="menu-item">
                    <a href="<?php echo e(route('account.editProfile')); ?>" class="menu-link <?php echo e(request()->routeIs('account.editProfile') ? 'active' : ''); ?>">
                        <div class="menu-icon">
                ...
                <li class="menu-item">
                    <a href="<?php echo e(route('account.changePassword')); ?>" class="menu-link <?php echo e(request()->routeIs('account.changePassword') ? 'active' : ''); ?>">
                        <div class="menu-icon">
        ...
        <div class="menu-section">
            ...
            <ul class="menu-list">
                <li class="menu-item">
                    <a href="<?php echo e(route('client.addresses.index')); ?>" class="menu-link <?php echo e(request()->routeIs('client.addresses.*') ? 'active' : ''); ?>">
                        <div class="menu-icon">
                ...
                <li class="menu-item">
                    <a href="<?php echo e(route('client.orders.index')); ?>" class="menu-link <?php echo e(request()->routeIs('orders.*') ? 'active' : ''); ?>">
                        <div class="menu-icon">
                ...
                <li class="menu-item">
                    <a href="<?php echo e(route('wishlist.index')); ?>" class="menu-link <?php echo e(request()->routeIs('wishlist.*') ? 'active' : ''); ?>">
                        <div class="menu-icon">
...
function uploadAvatar(input) {
    ...
    if (input.files && input.files[0]) {
        ...
        fetch('<?php echo e(route('account.uploadAvatar')); ?>', {
            method: 'POST',
            body: formData
        })
        .then(response => {
...
function uploadCoverImage(input) {
    if (input.files && input.files[0]) {
        ...
        fetch('<?php echo e(route('account.uploadCoverImage')); ?>', {
            method: 'POST',
            body: formData
        })
...
<?php /**PATH C:\laragon\www\DATN\Encryption-Shop\resources\views/client/account/sidebar.blade.php ENDPATH**/ ?>