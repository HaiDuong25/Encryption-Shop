<?php $__env->startSection('content'); ?>
    ...
    <?php if(session('info')): ?>
        <div class="alert alert-info alert-dismissible fade show" role="alert">
            <i class="fa-solid fa-info-circle me-2"></i><?php echo e(session('info')); ?>
    ...
    <?php if(session('warning')): ?>
        <div class="alert alert-warning alert-dismissible fade show" role="alert">
            <i class="fa-solid fa-exclamation-triangle me-2"></i><?php echo e(session('warning')); ?>
    ...
    <div class="container py-4">
        <div class="d-flex align-items-center mb-4">
            ...
            <span class="ms-3 badge bg-primary fs-6"><?php echo e($carts->count()); ?> sản phẩm</span>
        </div>
        ...
        <?php if($carts->count() > 0): ?>
                <div class="row g-4">
                    ...
                    <div class="col-lg-8">
                                ...
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label fw-bold" for="select-all">
                                            Chọn tất cả (<span id="total-items"><?php echo e($carts->count()); ?></span>)
                                        </label>
                                    </div>
                        ...
                        <?php $__currentLoopData = $groupedCarts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $productCarts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="card product-card mb-3 shadow-sm border-0" data-product-id="<?php echo e($productId); ?>">
                                    <!-- Header sản phẩm với checkbox và thông tin -->
                                    <div class="card-header-custom">
                                        <div class="d-flex align-items-center">
                                            <div class="form-check me-3">
                                                <input type="checkbox" class="form-check-input product-checkbox"
                                                    id="product-<?php echo e($productId); ?>" data-product-id="<?php echo e($productId); ?>">
                                                <label class="form-check-label" for="product-<?php echo e($productId); ?>"></label>
                                            </div>
                                            ...
                                            <div class="shop-info">
                                                ...
                                                <div class="product-info">
                                                    <h6 class="product-name mb-1 fw-bold"><?php echo e($product->name); ?></h6>
                                                    <div class="product-meta small text-muted">
                                                        <span class="brand-name"><?php echo e($product->brand->name ?? 'Đang cập nhật'); ?></span>
                                                        <?php if($productCarts->count() > 1): ?>
                                                            <span class="mx-2">•</span>
                                                            <span class="variant-count text-primary"><?php echo e($productCarts->count()); ?> phân
                                                                loại</span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="card-body p-0">
                                        <?php $__currentLoopData = $productCarts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="variant-row <?php echo e($index < $productCarts->count() - 1 ? 'border-bottom' : ''); ?>"
                                                        ...
                                                        <div class="row align-items-center g-0 p-3">
                                                            ...
                                                            <div class="col-auto me-3">
                                                                <div class="form-check">
                                                                    <input type="checkbox" class="form-check-input cart-item-checkbox"
                                                                        id="cart-<?php echo e($cart->id); ?>" value="<?php echo e($cart->id); ?>" data-cart-id="<?php echo e($cart->id); ?>"
                                                                        data-product-id="<?php echo e($productId); ?>"
                                                                        data-price="<?php echo e($cart->variant->sale_price ?? $cart->variant->price ?? $cart->product->sale_price ?? $cart->product->price); ?>"
                                                                        data-quantity="<?php echo e($cart->quantity); ?>">
                                                                    <label class="form-check-label" for="cart-<?php echo e($cart->id); ?>"></label>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-auto me-3">
                                                                <div class="variant-image-wrapper">
                                                                    <img src="<?php echo e(asset($cart->variant && $cart->variant->image ? 'storage/' . $cart->variant->image : 'storage/' . $cart->product->image)); ?>"
                                                            ...
                                                            <div class="col variant-info-col">
                                                                <?php if($cart->variant): ?>
                                                                                    ...
                                                                                    <div class="variant-info d-flex flex-wrap gap-1">
                                                                                        <!-- Size dropdown -->
                                                                                        <?php if($currentSize): ?>
                                                                                                        <select class="form-select variant-select" data-cart-id="<?php echo e($cart->id); ?>"
                                                                                                            data-original-value="<?php echo e($cart->variant_id); ?>">
                                                                                                            <?php $__currentLoopData = $productVariants->flatMap(function ($v) {
                                                                                                            return $v->attributeValues->filter(fn($val) => $val->attribute->name === 'Size'); })->unique('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                                                <option value="<?php echo e($productVariants->filter(function ($v) use ($size, $currentColor) {
                                                                                                                    $hasSize = $v->attributeValues->contains('id', $size->id);
                                                                                                                    $hasColor = !$currentColor || $v->attributeValues->contains('id', $currentColor->id);
                                                                                                                    return $hasSize && $hasColor;
                                                                                                                })->first()->id ?? ''); ?>" <?php echo e($currentSize->id == $size->id ? 'selected' : ''); ?>>
                                                                                                                                    Size: <?php echo e($size->value); ?>
                                                                                        ...
                                                                                        <?php if($currentColor): ?>
                                                                                                        <select class="form-select variant-select" data-cart-id="<?php echo e($cart->id); ?>"
                                                                                                            data-original-value="<?php echo e($cart->variant_id); ?>">
                                                                                                            <?php $__currentLoopData = $productVariants->flatMap(function ($v) {
                                                                                                            return $v->attributeValues->filter(fn($val) => $val->attribute->name === 'Màu'); })->unique('id'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                                                <option value="<?php echo e($productVariants->filter(function ($v) use ($color, $currentSize) {
                                                                                                                    $hasColor = $v->attributeValues->contains('id', $color->id);
                                                                                                                    $hasSize = !$currentSize || $v->attributeValues->contains('id', $currentSize->id);
                                                                                                                    return $hasColor && $hasSize;
                                                                                                                })->first()->id ?? ''); ?>" <?php echo e($currentColor->id == $color->id ? 'selected' : ''); ?>>
                                                                                                                                    Màu: <?php echo e($color->value); ?>
                                                            ...
                                                            <div class="col-auto price-col me-4">
                                                                ...
                                                                <div class="price-display text-end">
                                                                    <?php if($salePrice && $salePrice < $originalPrice): ?>
                                                                        <div class="sale-price"><?php echo e(format_vnd($salePrice)); ?> VNĐ</div>
                                                                        <div class="original-price"><?php echo e(format_vnd($originalPrice)); ?> VNĐ</div>
                                                                    <?php else: ?>
                                                                        <div class="current-price"><?php echo e(format_vnd($currentPrice)); ?> VNĐ</div>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-auto quantity-col me-3">
                                                                <form action="<?php echo e(route('cart.update', $cart->id)); ?>" method="POST"
                                                                    ...
                                                                    <div class="qty-wrapper">
                                                                        <button type="button" class="qty-btn qty-minus" <?php echo e($cart->quantity <= 1 ? 'disabled' : ''); ?>>
                                                                            <i class="fa-solid fa-minus"></i>
                                                                        </button>
                                                                        <input type="number" name="quantity" value="<?php echo e($cart->quantity); ?>" min="1"
                                                            ...
                                                            <div class="col-auto total-col me-3">
                                                                <div class="item-total text-end">
                                                                    <?php echo e(format_vnd($currentPrice * $cart->quantity)); ?> VNĐ
                                                                </div>
                                                            </div>
                                    ...
                                    <div id="input-coupon-tab" class="voucher-tab-content" style="display: none;">
                                        ...
                                        <div class="mt-2 text-center">
                                            <small class="text-muted">
                                                ...
                                                Chưa có mã giảm giá? <a href="<?php echo e(route('coupons.index')); ?>" class="text-primary">Xem mã khả dụng</a>
                                            </small>
                                        </div>
                                    </div>
                            ...
                            <div class="card summary-card mb-3 shadow-sm border-0">
                                            ...
                                            <?php $__currentLoopData = $groupedCarts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $productCarts): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        ...
                                                                        <div class="order-item mb-2">
                                                                            <div class="fw-semibold text-dark mb-1" style="font-size: 13px;">
                                                                                ...
                                                                                Đơn thứ <?php echo e($orderIndex); ?>: <?php echo e(Str::limit($product->name, 30)); ?>

                                                                            </div>
                                                                            <?php $__currentLoopData = $productCarts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cart): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                                                    <div class="variant-item ms-3 mb-1" style="font-size: 12px; color: #666;">
                                                                                                        ...
                                                                                                        <?php if($cart->variant): ?>
                                                                                                                                    ...
                                                                                                                                    ?>
                                                                                                                                    <?php echo e(implode(', ', $variantInfo)); ?>:
                                                                                                                                    <span class="text-primary fw-semibold"><?php echo e($cart->quantity); ?> sp</span>
                                                                                                        <?php else: ?>
                                                                                                            Sản phẩm cơ bản:
                                                                                                            <span class="text-primary fw-semibold"><?php echo e($cart->quantity); ?> sp</span>
                                                                                                        <?php endif; ?>
                                ...
                                <div class="action-buttons mt-4">
                                    <?php if(auth()->guard()->check()): ?>
                                        <a href="<?php echo e(route('client.addresses.index')); ?>"
                                    ...
                                    <?php if($carts->count() > 0): ?>
                                        ...
                                        <form id="checkout-form" action="<?php echo e(route('cart.checkout')); ?>" method="GET"
                                            style="display: none;">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function saveSelections() {
                const checkedItems = document.querySelectorAll('.cart-item-checkbox:checked');
                const selectedIds = Array.from(checkedItems).map(checkbox => checkbox.getAttribute('data-cart-id'));
                const userId = <?php echo e(Auth::id() ?? 'guest'); ?>;
...
<?php echo $__env->make('client.layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\DATN\Encryption-Shop\resources\views/client/cart/index.blade.php ENDPATH**/ ?>