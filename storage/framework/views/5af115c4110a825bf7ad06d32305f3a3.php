                    ...
                    <?php if($banners && $banners->count() > 0): ?>
                                <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="carousel-item <?php echo e($index == 0 ? 'active' : ''); ?>">
                                                ...
                                                ?>
                                                <img src="<?php echo e(asset('storage/' . $mainImage)); ?>" class="d-block w-100 banner-img-large"
                                                    alt="<?php echo e($banner->title); ?>">
                                                <div class="carousel-caption d-none d-md-block text-start">
                                                    <h2 class="fw-bold display-5 mb-2"><?php echo e($banner->title); ?></h2>
                                                    <?php if($banner->description): ?>
                                                        <p class="lead mb-3"><?php echo e($banner->description); ?></p>
                                                    <?php endif; ?>
                                                    <?php if($banner->link): ?>
                                                        <a href="<?php echo e($banner->link); ?>" class="btn btn-lg btn-primary px-4 py-2">
                                                            Xem ngay
                                                        </a>
                                                    <?php endif; ?>
                                                </div>
                            ...
                            <div class="category-box-modern text-center w-100 h-100">
                                <div class="category-image-container">
                                    <a href="<?php echo e(route('categories.show', $category->id)); ?>">
                                        <img src="<?php echo e($category->image ? asset('storage/' . $category->image) : 'https://images.unsplash.com/photo-1556905055-8f358a7a47b2?auto=format&fit=crop&w=600&q=80'); ?>"
                                            class="img-fluid category-img-modern mx-auto" alt="<?php echo e($category->name); ?>">
                                    </a>
                                    <div class="category-overlay">
                                        <div class="category-info">
                                            <h4 class="category-title"><?php echo e($category->name); ?></h4>
                                            <span class="category-count"><?php echo e($category->totalProductsCount()); ?> sản phẩm</span>
                                        </div>
                                    </div>
                                </div>
                                <button onclick="location.href = '<?php echo e(route('categories.show', $category->id)); ?>';"
                ...
                <?php else: ?>
                    ...
                    <div class="col d-flex">
                        <div class="category-box-modern text-center w-100 h-100">
                            ...
                            <button onclick="location.href = '<?php echo e(route('categories.index')); ?>';"
                                class="btn btn-category-modern mt-3">
                                <span>Khám phá ngay</span>
                                <i class="fas fa-arrow-right ms-2"></i>
                            </button>
        ...
        <div class="container-fluid-lg">
            ...
            <div class="row row-cols-1 row-cols-md-3 g-5 justify-content-center">
                <?php if($coupons && $coupons->count() > 0): ?>
                        <?php $__currentLoopData = $coupons->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $coupon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col">
                                    <?php
                                        $colors = [
                                    ...
                                    <div class="voucher-card h-100 text-center"
                                        style="background: <?php echo e($colorScheme['bg']); ?>; border-radius: 2rem; box-shadow: 0 10px 30px <?php echo e($colorScheme['shadow']); ?>; transition: all 0.3s ease; overflow: hidden; position: relative;"
                                        onmouseover="this.style.transform='translateY(-10px)'; this.style.boxShadow='0 20px 40px <?php echo e($colorScheme['shadow_hover']); ?>';"
                                        onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 10px 30px <?php echo e($colorScheme['shadow']); ?>';">
                                        <div class="voucher-decoration"
                                            style="position: absolute; top: -20px; right: -20px; width: 80px; height: 80px; background: <?php echo e($colorScheme['decoration']); ?>; border-radius: 50%; transform: rotate(45deg);">
                                        </div>
                                        <div class="card-body d-flex flex-column align-items-center justify-content-between py-4 px-4"
                                            ...
                                            <div class="voucher-icon mb-3">
                                                <i class="fa-solid fa-gift fa-3x <?php echo e($colorScheme['icon_color']); ?>"
                                                    style="background: <?php echo e($colorScheme['icon_bg']); ?>; border-radius: 50%; padding: 20px; box-shadow: 0 8px 20px <?php echo e($colorScheme['icon_shadow']); ?>;"></i>
                                            </div>
                                            <div class="voucher-code mb-3">
                                                <span
                                                    class="badge <?php echo e($colorScheme['badge_class']); ?> px-4 py-2 rounded-pill shadow-sm fw-bold"
                                                    style="font-size:1.2rem; letter-spacing: 1px;"><?php echo e($coupon->code); ?></span>
                                            </div>
                                            <h4 class="fw-bold <?php echo e($colorScheme['text_color']); ?> mb-3" style="font-size:1.4rem;">
                                            ...
                                            <div class="mb-3">
                                                <?php if($coupon->description): ?>
                                                    <p class="text-muted mb-2" style="font-size:1rem;"><?php echo e($coupon->description); ?></p>
                                                <?php endif; ?>
                                                <?php if($coupon->min_order_amount): ?>
                                                    <small class="text-info d-block">
                                                        <i class="fa-solid fa-shopping-cart me-1"></i>
                                                        Đơn tối thiểu: <?php echo e(format_vnd($coupon->min_order_amount)); ?>₫
                                                    </small>
                                                <?php endif; ?>
                                            </div>
                                            <?php if($coupon->start_date && $coupon->end_date): ?>
                                                <p class="text-muted mb-2" style="font-size:1.1rem;">
                                                    Từ <?php echo e($coupon->start_date->format('d/m/Y')); ?> đến <?php echo e($coupon->end_date->format('d/m/Y')); ?>

                                                </p>
                                            <?php elseif($coupon->expires_at): ?>
                                                <p class="text-muted mb-2" style="font-size:1.1rem;">
                                                    Hết hạn: <?php echo e($coupon->expires_at->format('d/m/Y')); ?>
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <div class="d-flex justify-content-between align-items-center mb-1">
                                                                    <small class="text-muted">Còn lại:
                                                                        <strong><?php echo e($remaining); ?>/<?php echo e($coupon->usage_limit); ?></strong></small>
                                                                    <small class="text-muted"><?php echo e(round($usagePercent)); ?>% đã dùng</small>
                                                                </div>
                                                                <div class="progress" style="height: 6px; border-radius: 3px;">
                                                                    <div class="progress-bar <?php echo e($remaining <= 5 ? 'bg-danger' : ($remaining <= 15 ? 'bg-warning' : 'bg-success')); ?>"
                                                                        role="progressbar" style="width: <?php echo e($usagePercent); ?>%; transition: width 0.3s ease;"
                                                                        aria-valuenow="<?php echo e($usagePercent); ?>" aria-valuemin="0" aria-valuemax="100">
                                                                    </div>
                                                                </div>
                                                                <?php if($remaining <= 5): ?>
                                            ...
                                            ?>
                                            <button
                                                class="btn <?php echo e($isSaved ? 'btn-success' : $colorScheme['btn_class']); ?> btn-lg fw-bold px-4 py-2 rounded-pill save-coupon-btn mb-3 shadow-lg <?php echo e($isDisabled ? 'disabled' : ''); ?>"
                                                data-code="<?php echo e($coupon->code); ?>" 
                                                data-discount="<?php echo e($discountText); ?>"
                                                data-description="<?php echo e($coupon->description ?? 'Mã giảm giá đặc biệt'); ?>"
                                                data-discount-type="<?php echo e($coupon->discount_type ?? 'percentage'); ?>"
                                                data-discount-value="<?php echo e($coupon->discount); ?>"
                                                data-max-discount="<?php echo e($coupon->max_discount_amount ?? ''); ?>"
                                                data-min-order="<?php echo e($coupon->min_order_amount ?? ''); ?>"
                                                style="font-size:1.1rem; min-width: 180px; transition: all 0.3s ease; <?php echo e($isDisabled ? 'opacity: 0.6; cursor: not-allowed;' : ''); ?>"
                                                <?php echo e($isDisabled ? 'disabled' : ''); ?>

                                                onmouseover="<?php echo e($isDisabled ? '' : 'this.style.transform=\'scale(1.05)\';'); ?>"
                                                onmouseout="<?php echo e($isDisabled ? '' : 'this.style.transform=\'scale(1)\';'); ?>">
                                                <i class="fa-solid fa-<?php echo e($isDisabled ? 'check' : ($isSaved ? 'check' : 'bookmark')); ?> me-2"></i>
                                                <?php echo e($isDisabled ? 'Đã sử dụng' : ($isSaved ? 'Đã lưu' : 'Lưu mã')); ?>
                    ...
                    <div class="col-12">
                        <div class="empty-voucher-state text-center py-5"
                            ...
                            <div class="d-flex justify-content-center gap-3 flex-wrap">
                                <a href="<?php echo e(route('client.coupons.index')); ?>" class="btn btn-outline-primary rounded-pill px-4 py-2">
                                    <i class="fa-solid fa-search me-2"></i>Tìm mã giảm giá
                                </a>
                                <a href="<?php echo e(route('my-coupons')); ?>" class="btn btn-outline-warning rounded-pill px-4 py-2">
            ...
            <div class="d-flex justify-content-center mt-5">
                <div class="btn-group" role="group">
                    <a href="<?php echo e(route('client.coupons.index')); ?>" class="btn btn-outline-primary btn-lg rounded-pill px-5 py-3 fw-semibold me-3"
                    ...
                    <a href="<?php echo e(route('my-coupons')); ?>" class="btn btn-outline-warning btn-lg rounded-pill px-5 py-3 fw-semibold"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function saveCoupon(couponId, couponCode, discountText) {
                return fetch('<?php echo e(route("client.coupons.save")); ?>', {
                    method: 'POST',
                    headers: {
            ...
            document.querySelectorAll('.save-coupon-btn').forEach(function (btn) {
                btn.addEventListener('click', function () {
                    ...
                    const couponId = <?php echo json_encode($coupons->pluck('id', 'code'), 512) ?>;
                            ...
                            <div class="col">
                                <div class="product-card-modern shadow-lg border-0 h-100 d-flex flex-column"
                                    ...
                                    <div class="card-body d-flex flex-column justify-content-between w-100 flex-grow-1 p-4"
                                        ...
                                        <!-- Product Name -->
                                        <a href="<?php echo e(route('client.products.show', $product->id)); ?>" class="text-decoration-none">
                                        ...
                                        <div class="product-rating d-flex justify-content-center align-items-center mb-3">
                                            ...
                                            <div class="stars d-flex">
                                                <?php for($i = 0; $i < 5; $i++): ?>
                                                    <i class="fa-solid fa-star <?php echo e($i < $avgRate ? 'text-warning' : 'text-muted'); ?>"
                                            ...
                                            <span class="text-muted ms-2 fw-medium" style="font-size: 0.9rem;">
                                                (<?php echo e(number_format($avgRate, 1)); ?>) • <?php echo e($product->rates->where('status', 1)->count()); ?>
                                            ...
                                            <?php if($product->sale_price && $product->sale_price < $product->price): ?>
                                                <div class="d-flex align-items-center gap-2">
                                                    <span class="fw-bold text-danger"
                                                        ...
                                                        <?php echo e(format_vnd($product->sale_price)); ?>₫
                                                    </span>
                                                    <span class="text-muted text-decoration-line-through" style="font-size: 1rem;">
                                                        <?php echo e(format_vnd($product->price)); ?>₫
                                                    </span>
                                                </div>
                                                <div class="text-success fw-semibold" style="font-size: 0.9rem;">
                                                    💰 Tiết kiệm <?php echo e(format_vnd($product->price - $product->sale_price)); ?>₫
                                                </div>
                                            <?php else: ?>
                                                <span class="fw-bold text-danger"
                                                    style="font-size: 1.4rem; text-shadow: 0 2px 4px rgba(220, 53, 69, 0.2);">
        ...
        <div class="container-fluid-lg">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-5 justify-content-center">
                <?php if($news && $news->count() > 0): ?>
                        <?php $__currentLoopData = $news->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col">
                                    <div class="card border-0 shadow-lg h-100 news-card"
                                        ...
                                        <div class="position-relative" style="overflow: hidden; border-radius: 2rem 2rem 0 0;">
                                            ...
                                            ?>
                                            <img src="<?php echo e($imageUrl); ?>" class="card-img-top img-fluid" alt="<?php echo e($article->title); ?>"
                                            ...
                                            <div class="position-absolute top-0 start-0 p-3">
                                                ...
                                                ?>
                             <span
                                                    class="badge <?php echo e($badgeColors[$badgeIndex]); ?> px-3 py-2 rounded-pill shadow-sm fw-bold">
                                                    <?php echo e($badges[$badgeIndex]); ?>
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between p-4">
                                            <div class="mb-3">
                                                <div class="text-muted small mb-2">
                                                    <i
                                                        class="fa-solid fa-calendar-days me-2"></i><?php echo e($article->created_at->format('j \T\h\á\n\g n, Y')); ?>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <a href="<?php echo e(route('client.news.show', $article->id)); ?>"
                                                ...
                                                <div class="d-flex align-items-center text-muted">
                                                    ...
                                                    <span><?php echo e(rand(200, 2000)); ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col">
                        <div class="card border-0 shadow-lg h-100 news-card"
                            ...
                            <div class="card-body d-flex flex-column justify-content-between p-4">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <a href="<?php echo e(route('client.news.index')); ?>"
                                        class="btn btn-warning rounded-pill fw-semibold text-white px-4 py-2"
...
<?php echo $__env->make('client.layout.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\DATN\Encryption-Shop\resources\views/client/home.blade.php ENDPATH**/ ?>