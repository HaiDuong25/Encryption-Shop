...
<head>
    ...
    <!-- Linear Icon css -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/linearicon.css')); ?>">
    ...
    <!-- ratio css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/ratio.css')); ?>">

    <!-- remixicon css -->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/remixicon.css')); ?>">
...
<body>
    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper">
            ...
            <div class="header-wrapper m-0">
                <div class="header-logo-wrapper p-0">
                    <div class="logo-wrapper">
                        <a href="index.html">
                            <img class="img-fluid main-logo" src="<?php echo e(asset('assets/images/logo/1.png')); ?>" alt="logo">
                            <img class="img-fluid white-logo" src="<?php echo e(asset('assets/images/logo/1-white.png')); ?>"
                                alt="logo">
                        </a>
                    </div>
                    <div class="toggle-sidebar">
                        ...
                        <a href="index.html">
                            <img src="<?php echo e(asset('assets/images/logo/1.png')); ?>" class="img-fluid" alt="">
                        </a>
                    </div>
                </div>
                        ...
                        <li class="profile-nav onhover-dropdown pe-0 me-0">
                            <div class="media profile-media">
                                <img class="user-profile rounded-circle"
                                    src="<?php echo e(auth()->user()->avatar ? asset('storage/' . auth()->user()->avatar) : asset('assets/images/users/favi.png')); ?>"
                                    alt="">
        ...
        </div><?php /**PATH C:\laragon\www\DATN\Encryption-Shop\resources\views/admin/layouts/partials/header.blade.php ENDPATH**/ ?>