                ...
                <table class="table theme-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <ul>
                                    <li><a href="{{ route('users.show', $user) }}" title="Xem chi tiết"><i class="ri-eye-line"></i></a></li>
                                    ...
                                    <li><a href="{{ route('users.edit', $user) }}" title="Chỉnh sửa"><i class="ri-pencil-line"></i></a></li>
