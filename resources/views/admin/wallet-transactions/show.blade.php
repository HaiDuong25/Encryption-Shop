                ...
                <div class="col-md-8">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0" style="background: transparent;">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.wallet-transactions.index') }}"
                                    class="text-white-50">Giao dịch ví</a></li>
            ...
            <div class="row mt-4">
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <code
                            class="bg-white bg-opacity-90 text-dark p-2 rounded d-inline-block small">{{ $transaction->transaction_code }}</code>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="text-center">
                        ...
                        <table class="table table-hover mb-0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold">{{ number_format($transaction->balance_before, 0, ',', '.') }} VND
                                    </td>
                                </tr>
                                <tr>
                                    <td class="fw-bold">
                                    ...
                                    <td class="fw-bold text-primary">
                                        {{ number_format($transaction->balance_after, 0, ',', '.') }} VND</td>
                                </tr>
                                <tr>
                                    <td class="fw-bold">
                ...
                <div class="card user-info-card">
                    <div class="card-body">
                        <div class="mb-4">
                            ...
                            <p class="text-muted">
                                <i class="fas fa-calendar me-2"></i>Tham gia:
                        ...
                        @if ($userWallet)
                            <div class="bg-light p-3 rounded mb-3">
                                ...
                                <h3 class="text-success mb-0">{{ number_format($userWallet->balance, 0, ',', '.') }} VND
                                </h3>
                            </div>
                        @endif
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body action-buttons">
                            @if ($transaction->status === 'pending')
                                <form action="{{ route('admin.wallet-transactions.update-status', $transaction->id) }}"
                                    method="POST" class="mb-3">
                                    @csrf
                                    <input type="hidden" name="status" value="completed">
                                    <button type="submit" class="btn btn-success w-100"
                                        onclick="return confirm('Bạn có chắc muốn đánh dấu giao dịch này là hoàn thành?')">
                                ...
                                <form action="{{ route('admin.wallet-transactions.update-status', $transaction->id) }}"
                                    ...
                                    <button type="submit" class="btn btn-danger w-100"
                                        onclick="return confirm('Bạn có chắc muốn đánh dấu giao dịch này là thất bại?')">
                ...
                @if ($transaction->status === 'failed' && $transaction->type === 'payment')
                    <div class="card mt-3 border-danger">
                        ...
                        <div class="card-body">
                            ...
                            <form action="{{ route('admin.wallet-transactions.destroy', $transaction->id) }}"
                                method="POST">
                                @csrf
                                @method('DELETE')
                                <button type="submit" class="btn btn-danger w-100"
                                    onclick="return confirm('BẠN CÓ CHẮC MUỐN XÓA GIAO DỊCH THANH TOÁN NÀY? Hành động này không thể hoàn tác và sẽ xóa vĩnh viễn dữ liệu.')">
                    ...
                    <div class="card mt-3 border-warning">
                        ...
                        <div class="card-body">
                            <p class="text-muted mb-3">
                                ...
                                Giao dịch nạp tiền thất bại không thể được xóa khỏi hệ thống để đảm bảo tính minh bạch và
                                truy xuất nguồn gốc.
                            </p>
