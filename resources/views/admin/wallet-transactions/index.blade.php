                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <select name="payment_method_type" class="form-select">
                            <option value="">Tất cả</option>
                            <option value="MOMO" {{ request('payment_method_type') === 'MOMO' ? 'selected' : '' }}>MoMo</option>
                            <option value="ZALOPAY" {{ request('payment_method_type') === 'ZALOPAY' ? 'selected' : '' }}>ZaloPay</option>
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <div class="w-100">
                            ...
                            <a href="{{ route('admin.wallet-transactions.index') }}" class="btn btn-outline-secondary w-100">
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a class="dropdown-item" href="{{ route('admin.wallet-transactions.show', $transaction->id) }}">
                                                ...
                                                @if($transaction->status === 'pending')
                                                    ...
                                                    <li>
                                                        <form action="{{ route('admin.wallet-transactions.update-status', $transaction->id) }}" method="POST" class="d-inline">
                                                            @csrf
                                                            <input type="hidden" name="status" value="completed">
                                                            <button type="submit" class="dropdown-item text-success" onclick="return confirm('Xác nhận hoàn thành giao dịch?')">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('admin.wallet-transactions.update-status', $transaction->id) }}" method="POST" class="d-inline">
                                                            ...
                                                            <button type="submit" class="dropdown-item text-danger" onclick="return confirm('Xác nhận đánh dấu thất bại?')">
                                                ...
                                                @if($transaction->status === 'failed')
                                                    ...
                                                    @if($transaction->type === 'payment')
                                                        <li>
                                                            <form action="{{ route('admin.wallet-transactions.destroy', $transaction->id) }}" method="POST" class="d-inline">
                                                                @csrf
                                                                @method('DELETE')
                                                                <button type="submit" class="dropdown-item text-danger" onclick="return confirm('Bạn có chắc muốn xóa giao dịch thanh toán thất bại này?')">
                                                    ...
                                                    @else
                                                        <li>
                                                            <span class="dropdown-item text-muted">
                                                                <i class="fas fa-ban me-2"></i>Không thể xóa đơn nạp tiền
                                                            </span>
                                                        </li>
                                                    @endif
                                                @endif
