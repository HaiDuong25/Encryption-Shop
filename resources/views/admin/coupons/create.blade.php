        ...
        <div class="col-lg-12">
            <div class="card shadow border-0 rounded-4">
                <div class="card-body p-5">
                    <h2 class="mb-4 text-center fw-bold text-success">Tạo mã giảm giá</h2>
                    ...
                    <form id="couponForm">
                        ...
                        <div class="mb-4">
                            <label for="code" class="form-label fw-semibold text-success">Mã giảm giá (tùy chọn)</label>
                            <input type="text" name="code" id="code" class="form-control"
                                placeholder="Để trống để tự động tạo mã" maxlength="50">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="3"
                                placeholder="Mô tả về mã giảm giá này..." maxlength="500"></textarea>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="discount" id="discount" class="form-control" required min="1" max="100"
                                    placeholder="Nhập giá trị giảm giá">
                                <div class="form-text" id="discount-help">Nhập giá trị từ 1 đến 100</div>
                            </div>
                        </div>

                        <div class="mb-4 mt-4" id="max-discount-container" style="display: none;">
                            ...
                            <input type="number" name="max_discount_amount" id="max_discount_amount" class="form-control"
                                min="0" step="1" placeholder="Nhập số tiền giảm tối đa">
                        ...
                        <div class="row g-4">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="min_order_amount" id="min_order_amount" class="form-control"
                                    min="0" step="1" placeholder="Không yêu cầu nếu để trống">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="usage_limit" id="usage_limit" class="form-control"
                                    min="0" placeholder="0 = không giới hạn" value="0">
                            </div>
                        </div>
