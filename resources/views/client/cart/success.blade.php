                    ...
                    <div class="breadcrumb-contain breadcrumb-order">
                        <div class="order-box">
                            ...
                            <div class="order-contain">
                                ...
                                <h5 class="text-content">
                                    @if ($isOnlinePayment)
                                        @if ($latestPayment->payment_method_type === 'MoMo')
                                            <i class="fas fa-mobile-alt text-info me-2"></i>Thanh toán MoMo thành công! Đơn
                                            hàng sẽ được xử lý ngay.
                                        @elseif($latestPayment->payment_method_type === 'ZaloPay')
                                            <i class="fas fa-wallet text-primary me-2"></i>Thanh toán ZaloPay thành công!
                                            Đơn hàng sẽ được xử lý ngay.
                                        @endif
                                    @elseif($isCOD)
                                        <i class="fas fa-money-bill-wave text-success me-2"></i>Đơn hàng COD đã được tạo!
                                ...
                                <div class="order-info-card mt-3 p-3"
                                    style="background-color: #f8f9fa; border-radius: 8px; border-left: 4px solid #007bff;">
                                    <h6 class="mb-2"><i class="fas fa-receipt me-2"></i>Thông tin đơn hàng</h6>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <p class="mb-1"><strong>Mã đơn hàng:</strong> <span
                                                    class="text-primary">#{{ $order->id }}</span></p>
                                            <p class="mb-1"><strong>Ngày đặt:</strong>
                                                {{ $order->created_at->format('d/m/Y H:i') }}</p>
                                            <p class="mb-1"><strong>Phương thức:</strong>
                                                {{ $paymentMethod->payment_type ?? 'N/A' }}</p>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            @if ($order->orderDetails && $order->orderDetails->count() > 0)
                                                <div class="mb-1">
                                                    ...
                                                    <p class="mb-1"><strong>Tổng tiền:</strong> <span
                                                            class="text-success fs-5 fw-bold">{{ format_vnd($order->total_price ?? $order->total) }}đ</span>
                                                    </p>
                                ...
                                @if ($isOnlinePayment)
                                    ...
                                    <div class="payment-details-card mt-2 p-3"
                                        style="background-color: #e8f5e8; border-radius: 8px; border-left: 4px solid #28a745;">
                                        <h6 class="mb-2 text-success"><i class="fas fa-check-circle me-2"></i>Chi tiết giao
                                            dịch thành công</h6>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <span
                                                        class="badge bg-info fs-6">{{ $latestPayment->payment_method_type }}</span>
                                                </div>
                                                @if ($latestPayment->transaction_code)
                                                    <div class="mb-1">
                                                        <small class="text-muted">Mã giao dịch:</small><br>
                                                        <strong
                                                            class="text-primary">{{ $latestPayment->transaction_code }}</strong>
                                                    </div>
                                                @endif
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="alert alert-success mt-2 mb-0">
                                            <small><i class="fas fa-info-circle me-1"></i>
                                                Giao dịch đã được xác nhận thành công. Đơn hàng sẽ được chuẩn bị và giao
                                                trong 1-2 ngày làm việc.</small>
                                        </div>
                                    </div>
                                @elseif($isCOD)
                                    <!-- Thanh toán COD -->
                                    <div class="payment-details-card mt-2 p-3"
                                        style="background-color: #fff3cd; border-radius: 8px; border-left: 4px solid #ffc107;">
                                        <h6 class="mb-2 text-warning"><i class="fas fa-money-bill-wave me-2"></i>Thanh toán
                                            khi nhận hàng (COD)</h6>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                ...
                                                <div class="mb-1">
                                                    ...
                                                    <strong
                                                        class="text-danger fs-5">{{ format_vnd($order->total_price ?? $order->total) }}đ</strong>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <strong
                                                        class="text-success">{{ $order->created_at->addDays(2)->format('d/m/Y') }}
                                                        - {{ $order->created_at->addDays(4)->format('d/m/Y') }}</strong>
                                                </div>
                                                <div class="mb-1">
                                        ...
                                        <div class="alert alert-warning mt-2 mb-0">
                                            <small><i class="fas fa-info-circle me-1"></i>
                                                Vui lòng chuẩn bị đúng số tiền khi nhận hàng. Shipper sẽ liên hệ bạn trước
                                                khi giao hàng.</small>
                                        </div>
                                    </div>
                                @endif
