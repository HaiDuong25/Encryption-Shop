        ...
        <div class="container-fluid-lg">
            ...
            <div class="sub-footer sub-footer-lite section-b-space section-t-space">
                ...
                <ul class="payment-box">
                    <li>
                        <img src="{{ asset('assets-front/images/icon/paymant/visa.png') }}" class="blur-up lazyload" alt="">
                    </li>
                    <li>
                        <img src="{{ asset('assets-front/images/icon/paymant/discover.png') }}" alt="" class="blur-up lazyload">
                    </li>
                    <li>
                        <img src="{{ asset('assets-front/images/icon/paymant/american.png') }}" alt="" class="blur-up lazyload">
                    </li>
                    <li>
                        <img src="{{ asset('assets-front/images/icon/paymant/master-card.png') }}" alt="" class="blur-up lazyload">
                    </li>
                    <li>
                        <img src="{{ asset('assets-front/images/icon/paymant/giro-pay.png') }}" alt="" class="blur-up lazyload">
                    </li>
                </ul>
            </div>
        </div>
