            ...
            <div class="row row-cols-1 row-cols-md-3 g-5 justify-content-center">
                ...
                <div class="col">
                    <div class="voucher-card h-100 text-center"
                        ...
                        <div class="voucher-decoration" style="position: absolute; top: -20px; right: -20px; width: 80px; height: 80px; background: rgba(255, 193, 7, 0.1); border-radius: 50%; transform: rotate(45deg);"></div>
                        <div class="card-body d-flex flex-column align-items-center justify-content-between py-4 px-4" style="position: relative; z-index: 1;">
                            ...
                            <span class="badge bg-white text-warning border border-warning px-3 py-1 shadow-sm" style="font-size: 0.9rem; font-weight: 600;">🔥 Hot</span>
                        </div>
                    </div>
                </div>
                <!-- Voucher 2 -->
                <div class="col">
                    <div class="voucher-card h-100 text-center"
                        ...
                        <div class="voucher-decoration" style="position: absolute; top: -20px; right: -20px; width: 80px; height: 80px; background: rgba(40, 167, 69, 0.1); border-radius: 50%; transform: rotate(45deg);"></div>
                        <div class="card-body d-flex flex-column align-items-center justify-content-between py-4 px-4" style="position: relative; z-index: 1;">
                            <div class="voucher-icon mb-3">
                            ...
                            <span class="badge bg-white text-success border border-success px-3 py-1 shadow-sm" style="font-size: 0.9rem; font-weight: 600;">⚡ Giới hạn</span>
                        </div>
                    </div>
                </div>
                <!-- Voucher 3 -->
                <div class="col">
                    <div class="voucher-card h-100 text-center"
                        ...
                        <div class="voucher-decoration" style="position: absolute; top: -20px; right: -20px; width: 80px; height: 80px; background: rgba(0, 123, 255, 0.1); border-radius: 50%; transform: rotate(45deg);"></div>
                        <div class="card-body d-flex flex-column align-items-center justify-content-between py-4 px-4" style="position: relative; z-index: 1;">
                            <div class="voucher-icon mb-3">
                            ...
                            <span class="badge bg-white text-primary border border-primary px-3 py-1 shadow-sm" style="font-size: 0.9rem; font-weight: 600;">🚚 Freeship</span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="product-section-3 py-5">
        <div class="container-fluid-lg">
                        ...
                        <div class="product-card-modern shadow-lg border-0 h-100 d-flex flex-column"
                            ...
                            <div class="product-image-container bg-light d-flex align-items-center justify-content-center position-relative"
                                ...
                                <div class="product-quick-actions position-absolute"
                                    ...
                                    <button class="btn btn-light btn-sm rounded-circle d-flex align-items-center justify-content-center shadow-sm"
                                            style="width: 40px; height: 40px; background: rgba(255, 255, 255, 0.9); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.2); transition: all 0.3s ease;"
                            ...
                            <div class="card-body d-flex flex-column justify-content-between w-100 flex-grow-1 p-4"
                                ...
                                <div class="product-rating d-flex justify-content-center align-items-center mb-3">
                                    ...
                                    <span class="text-muted ms-2 fw-medium" style="font-size: 0.9rem;">
                                        ({{ number_format($avgRate, 1) }}) • {{ $product->rates->where('status', 1)->count() }} đánh giá
                                    </span>
                                </div>
                                ...
                                <div class="product-price d-flex flex-column align-items-center gap-1 mb-4">
                                    @if($product->sale_price && $product->sale_price < $product->price)
                                        <div class="d-flex align-items-center gap-2">
                                            <span class="fw-bold text-danger" style="font-size: 1.4rem; text-shadow: 0 2px 4px rgba(220, 53, 69, 0.2);">
                                ...
                                <div class="product-actions d-flex gap-2">
                                    ...
                                    <a href="{{ route('client.products.show', $product->id) }}"
                                       class="btn btn-warning rounded-pill fw-bold px-4 position-relative overflow-hidden"
                                       style="color: #fff; background: linear-gradient(135deg, #ffc107 0%, #ff8f00 100%); border: none; box-shadow: 0 6px 20px rgba(255, 193, 7, 0.3); transition: all 0.3s ease; min-width: 120px;"
                                       onmouseover="this.style.transform='translateY(-2px) scale(1.05)'; this.style.boxShadow='0 12px 30px rgba(255, 193, 7, 0.4)'; this.style.background='linear-gradient(135deg, #ff8f00 0%, #ff6f00 100%)';"
                                       onmouseout="this.style.transform='translateY(0) scale(1)'; this.style.boxShadow='0 6px 20px rgba(255, 193, 7, 0.3)'; this.style.background='linear-gradient(135deg, #ffc107 0%, #ff8f00 100%)';">
            ...
            <div class="d-flex justify-content-center mt-5">
                <a href="{{ route('client.products.index') }}" class="btn btn-outline-primary btn-lg rounded-pill px-5 py-3 fw-semibold"
    ...
    <section class="news-section section-b-space py-5">
        <div class="container-fluid-lg">
            ...
            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-5 justify-content-center">
                <!-- News 1 -->
                <div class="col">
                    <div class="card border-0 shadow-lg h-100" style="border-radius: 2rem; overflow: hidden; transition: transform 0.3s ease;" 
                        ...
                        <div class="position-relative" style="overflow: hidden; border-radius: 2rem 2rem 0 0;">
                            ...
                            <div class="position-absolute top-0 start-0 p-3">
                                <span class="badge bg-warning text-dark px-3 py-2 rounded-pill shadow-sm fw-bold">Xu hướng</span>
                            </div>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-between p-4">
                            <div class="mb-3">
                                ...
                                <p class="card-text text-secondary mb-3" style="font-size:1.1rem; line-height: 1.6;">
                                    Khám phá những mẫu thiết kế mới nhất cho mùa thu đông, mang phong cách sang trọng và hiện đại cùng những gam màu ấm áp.
                                </p>
                            </div>
                    ...
                    <div class="card border-0 shadow-lg h-100" style="border-radius: 2rem; overflow: hidden; transition: transform 0.3s ease;" 
                        ...
                        <div class="position-relative" style="overflow: hidden; border-radius: 2rem 2rem 0 0;">
                            <img src="https://images.unsplash.com/photo-1517841905240-472988babdf9?auto=format&fit=crop&w=800&q=80"
                                ...
                                onmouseout="this.style.transform='scale(1)';">
                            <div class="position-absolute top-0 start-0 p-3">
                                <span class="badge bg-success text-white px-3 py-2 rounded-pill shadow-sm fw-bold">Bí quyết</span>
                            </div>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-between p-4">
                            <div class="mb-3">
                                ...
                                <p class="card-text text-secondary mb-3" style="font-size:1.1rem; line-height: 1.6;">
                                    Gợi ý cách phối đồ công sở giúp bạn tự tin và nổi bật mỗi ngày tại nơi làm việc với phong cách chuyên nghiệp.
                                </p>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="#" class="btn btn-warning rounded-pill fw-semibold text-white px-4 py-2"
                    ...
                    <div class="card border-0 shadow-lg h-100" style="border-radius: 2rem; overflow: hidden; transition: transform 0.3s ease;" 
                        ...
                        <div class="position-relative" style="overflow: hidden; border-radius: 2rem 2rem 0 0;">
                            <img src="https://images.unsplash.com/photo-1512436991641-6745cdb1723f?auto=format&fit=crop&w=800&q=80"
                                ...
                                onmouseout="this.style.transform='scale(1)';">
                            <div class="position-absolute top-0 start-0 p-3">
                                <span class="badge bg-primary text-white px-3 py-2 rounded-pill shadow-sm fw-bold">Hot</span>
                            </div>
                        </div>
                        <div class="card-body d-flex flex-column justify-content-between p-4">
                            <div class="mb-3">
                                ...
                                <p class="card-text text-secondary mb-3" style="font-size:1.1rem; line-height: 1.6;">
                                    Cập nhật các xu hướng phối đồ đơn giản, trẻ trung cho mùa hè năm nay với những gam màu tươi mới.
                                </p>
                            </div>
                            <div class="d-flex justify-content-between align-items-center">
                                <a href="#" class="btn btn-warning rounded-pill fw-semibold text-white px-4 py-2"
