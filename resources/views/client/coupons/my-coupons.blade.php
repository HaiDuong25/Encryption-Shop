            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center text-white">
                    <div class="hero-icon mb-4">
                        <i class="fa-solid fa-bookmark fa-4x" style="opacity: 0.9;"></i>
                    </div>
                    ...
                    <div class="hero-stats d-flex justify-content-center gap-4">
                        <div class="stat-item">
                            <div class="stat-number fw-bold" style="font-size: 2rem;">{{ $savedCoupons->total() }}</div>
                ...
                <div class="col-lg-10">
                        ...
                        <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <span class="badge bg-primary-subtle text-primary px-3 py-2 rounded-pill">
                                    {{ $savedCoupons->total() }} mã đã lưu
                                </span>
                            </div>
                            <div class="d-flex gap-2">
                                <a href="{{ route('client.coupons.index') }}" class="btn btn-outline-primary rounded-pill">
                                        ...
                                        <div class="card-body p-4" style="position: relative; z-index: 1;">
                                            ...
                                            <div class="conditions mb-3">
                                                ...
                                                <div class="condition-item d-flex align-items-center mb-2">
                                                    ...
                                                    <small class="text-muted">Đã lưu: {{ $savedCoupon->saved_at->format('d/m/Y H:i') }}</small>
                                                </div>
                                            </div>
                                            ...
                                            @elseif($isExpired)
                                                <div class="alert alert-warning py-2 px-3 mb-3 text-center" style="border-radius: 10px; font-size: 0.85rem;">
                                                    <i class="fa-solid fa-exclamation-triangle me-1"></i> Đã hết hạn
                                                </div>
                                            @elseif(!$coupon->canBeUsed())
                                                <div class="alert alert-danger py-2 px-3 mb-3 text-center" style="border-radius: 10px; font-size: 0.85rem;">
                                                    <i class="fa-solid fa-times-circle me-1"></i> Không khả dụng
                                                </div>
                                            @else
                                                <div class="alert alert-success py-2 px-3 mb-3 text-center" style="border-radius: 10px; font-size: 0.85rem;">
                                            ...
                                            <div class="text-center">
                                                <div class="alert alert-light border py-3 px-4 mb-0" style="border-radius: 15px; background: linear-gradient(135deg, #f8f9fa 0%, #ffffff 100%);">
                                                    <div class="d-flex align-items-center justify-content-center">
                                                        <i class="fa-solid fa-ticket {{ $colorScheme['icon_color'] }} me-2" style="font-size: 1.2rem;"></i>
                                                        <span class="fw-bold text-dark" style="font-size: 1.1rem; letter-spacing: 1px;">{{ $coupon->code }}</span>
                                                    </div>
                                    ...
                                    <div class="col-lg-4 col-md-6 mb-4">
                                        <div class="coupon-card h-100 opacity-50"
                                            ...
                                            <div class="card-body p-4 text-center">
                                                ...
                                                <p class="text-muted mb-3">Mã giảm giá này có thể đã bị xóa hoặc không còn tồn tại trong hệ thống.</p>
                    ...
                    @else
                        ...
                        <div class="text-center py-5">
                            ...
                            <p class="text-muted mb-4">Hãy khám phá và lưu các mã giảm giá hấp dẫn để tiết kiệm chi phí mua sắm!</p>
